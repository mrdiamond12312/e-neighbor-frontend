export const landing = {
  'landingpage.slogan.1': 'Linh hoạt và Tiện lợi',
  'landingpage.slogan.2': 'Thuê đồ Nhanh chóng, Kết nối Dễ dàng',
  ...
  'landingpage.role.admin.description':
    'Chủ của Hệ thống E-Neighbor - Quản trị viên. Quản trị viên sẽ Duyệt hoặc Từ chối các Sản phẩm được gửi lên từ phía Người cho Thuê (với các Sản phẩm mới thêm). Trong tương lai, nếu Hệ thống được phát triển, các công cụ Report và AI phân tích sẽ giúp họ làm việc hiệu quả hơn!',
};
